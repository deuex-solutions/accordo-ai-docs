...
graph TD
    ...
    classDef graphStyle fill:#f59e0b,stroke:#b45309,stroke-width:2px,color:#fff;
    ...
    Orchestrator["LangGraph StateGraph Orchestrator<br/>(Controls Workflow & State)"]:::graphStyle
